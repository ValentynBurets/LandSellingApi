...
namespace Business.Services.Authentication
{
    public class ProfileDataService : IProfileDataService
    {
        ...
        public async Task<UserInfoViewModel> GetCustomerProfileInfoById(Guid id)
        {
            ...
            var customer = await _unitOfWork.CustomerRepository.FirstOrDefault(x => x.IdLink == id);
            ...
            var profileInfo = _mapper.Map<Customer, UserInfoViewModel>(customer);
        ...
        {
            var student = await _unitOfWork.CustomerRepository.GetById(id);
